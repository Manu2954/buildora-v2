    ...
    return (
      <div className="bg-white p-8 rounded-2xl shadow-lg animate-fade-in">
        <div className="text-center">
          ...
          <h3 className="text-xl font-semibold text-text-base mb-2">Thank You!</h3>
  ...
  return (
    <div className="bg-white p-6 lg:p-8 rounded-2xl shadow-lg animate-slide-up">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <label className="form-label">Select or Describe Your Requirement *</label>
          <select
          ...
          {errors.requirement && <p className="form-error">{errors.requirement}</p>}
        </div>

        {formData.requirement === 'Other' && (
          <div>
            <label className="form-label">Please describe your requirement</label>
            <textarea
