...
function Form() {
    ...
    return (
      <div className="bg-white rounded-2xl p-6 lg:p-8 shadow-lg">
        <div className="text-center space-y-6">
          ...
          <div>
            <h3 className="text-2xl font-bold text-text-base mb-4">
              Thank You!
            </h3>
  ...
  return (
    <div className="bg-white rounded-2xl p-6 lg:p-8 shadow-lg">
      <div className="mb-6">
        <h2 className="text-2xl lg:text-3xl font-bold text-text-base mb-2">
          Get Started Today
        </h2>
        ...
        <div>
          ...
          <div className="space-y-3">
            <p className="text-sm text-gray-600">
              You can also select multiple interests:
            </p>
            {requirementOptions.map((option) => (
              <label
                key={option}
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    handleRequirementChange(option, e.target.checked)
                  }
          ...
          {(formData.requirement === "Other" ||
            ...
            <div className="mt-4">
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, otherRequirement: e.target.value })
                }
