...
const quickActions = [
  {
    title: "Custom Design",
    description: "Get a personalized design tailored to your style and space requirements",
    icon: Palette,
  ...
  },
  {
    ...
    description: "Schedule a free consultation with our interior design experts today",
    icon: Calendar,
    buttonText: "Book Now",
  ...
  return (
    <section className="px-4 lg:px-6 py-6 lg:py-8">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
        ...
        <div className="p-4 bg-muted/30 rounded-lg">
          <h4 className="font-semibold text-foreground mb-1">Expert Designers</h4>
