...
Please add the following logo files to the `/public` directory:
...
1. **buildora-icon.png** (or .svg)
   ...
   - Should be square or proportional
   - Transparent background recommended

2. **buildora-logo.png** (or .svg)
   - Full brand wordmark/logotype
   - Recommended size: 300x80px minimum
   - Used in navbar at ~32px height (desktop), ~24px (mobile)
   - Should include company name text
   - Transparent background recommended
