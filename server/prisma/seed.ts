      ...
      data: {
        ...
        milestones: {
          create: [
            ...
            },
            {
              ...
              status: PaymentStatus.PENDING,
              approved: false,
              dueDate: new Date("2024-10-05T00:00:00.000Z"),
            },
            {
              label: "Handover (10%)",
        ...
        worksiteMedia: {
          create: [
            ...
            {
              kind: MediaKind.IMAGE,
              url: "https://images.unsplash.com/photo-1489171078254-c3365d6e359f?q=80&w=1200&auto=format&fit=crop",
              caption: "Modular kitchen assembly",
            },
            {
              kind: MediaKind.VIDEO,
              url: "https://storage.googleapis.com/coverr-main/mp4/Mt_Baker.mp4",
              caption: "Walk-through update",
            },
          ],
        },
      },
